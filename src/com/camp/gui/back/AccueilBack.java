...
public class AccueilBack extends Form {
    ...
    private Button makeReclamationsButton() {
        ...
        button.addActionListener(action -> new com.camp.gui.back.reclamation.ShowAll(this).show());
        return button;
    }
    ...
    private Button makeAviscampsButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.camp.gui.back.aviscamp.ShowAll(this).show());
        return button;
    }
    ...
    private Button makeCommantairesButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.camp.gui.back.commantaire.ShowAll(this).show());
        return button;
    }
