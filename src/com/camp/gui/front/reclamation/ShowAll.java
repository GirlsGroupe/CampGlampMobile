package com.camp.gui.front.reclamation;
...
public class ShowAll extends Form {
    ...
    private Container makeModelWithoutButtons(Reclamation reclamation) {
        ...
        eventLabel = new Label("Event : " + reclamation.getEvent());
        ...
        eventLabel = new Label("Event : " + reclamation.getEvent().getNom());
        eventLabel.setUIID("labelDefault");

        utilisateurLabel = new Label("Utilisateur : " + reclamation.getUtilisateur().getNom());
        utilisateurLabel.setUIID("labelDefault");
