...
public class AviscampService {
    ...
    public ArrayList<Aviscamp> getAll() {
        ...
        cr = new ConnectionRequest();
        cr.setUrl(Statics.BASE_URL + "/aviscamp");
    ...
    public int manage(Aviscamp aviscamp, boolean isEdit) {
        ...
        if (isEdit) {
            cr.setUrl(Statics.BASE_URL + "/aviscamp/edit");
            cr.addArgument("id", String.valueOf(aviscamp.getId()));
        } else {
            cr.setUrl(Statics.BASE_URL + "/aviscamp/add");
        }
        ...
        cr.addArgument("utilisateur", String.valueOf(aviscamp.getUtilisateur().getId()));
    ...
    public int delete(int aviscampId) {
        cr = new ConnectionRequest();
        cr.setUrl(Statics.BASE_URL + "/aviscamp/delete");
        cr.setHttpMethod("POST");
