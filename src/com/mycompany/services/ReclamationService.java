...
public class ReclamationService {
    ...
    public ArrayList<Reclamation> getAll() {
        ...
        cr = new ConnectionRequest();
        cr.setUrl(Statics.Base_URL +"/mobile/reclamation");
    ...
    public int manage(Reclamation reclamation, boolean isEdit) {
        ...
        if (isEdit) {
            cr.setUrl(Statics.Base_URL + "/mobile/reclamation/edit");
            cr.addArgument("id", String.valueOf(reclamation.getId()));
        } else {
            cr.setUrl(Statics.Base_URL + "/mobile/reclamation/add");
        }
        ...
        cr.addArgument("utilisateur", String.valueOf(reclamation.getUtilisateur().getIdUser()));
    ...
    public int delete(int reclamationId) {
        cr = new ConnectionRequest();
        cr.setUrl(Statics.Base_URL + "/mobile/reclamation/delete");
        cr.setHttpMethod("POST");
