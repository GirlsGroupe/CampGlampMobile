...
public class CommantaireService {
    ...
    public ArrayList<Commantaire> getAll() {
        ...
        cr = new ConnectionRequest();
        cr.setUrl(Statics.Base_URL + "/mobile/commantaire");
    ...
    public int manage(Commantaire commantaire, boolean isEdit) {
        ...
        if (isEdit) {
            cr.setUrl(Statics.Base_URL + "/mobile/commantaire/edit");
            cr.addArgument("id", String.valueOf(commantaire.getId()));
        } else {
            cr.setUrl(Statics.Base_URL + "/mobile/commantaire/add");
        }
    ...
    public int delete(int commantaireId) {
        cr = new ConnectionRequest();
        cr.setUrl(Statics.Base_URL + "/mobile/commantaire/delete");
        cr.setHttpMethod("POST");
