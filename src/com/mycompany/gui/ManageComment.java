...
import com.mycompany.services.CommantaireService;
...
public class ManageComment extends Form {
    ...
    public ManageComment(Form previous) {
        super(ShowAllComment.currentCommantaire == null ? "Ajouter" : "Modifier", new BoxLayout(BoxLayout.Y_AXIS));
        this.previous = previous;

        currentCommantaire = ShowAllComment.currentCommantaire;
    ...
    private void showBackAndRefresh() {
        ((ShowAllComment) previous).refresh();
        previous.showBack();
    }
